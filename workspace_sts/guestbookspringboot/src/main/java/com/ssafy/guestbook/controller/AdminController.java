...
//    }
    ...
    @ApiOperation(value = "회원목록", notes = "<b>회원의</b> 전체목록을 리턴합니다.")
    ...
    @ApiOperation(value = "회원등록", notes = "회원정보를 받아서 DB에 저장합니다.")
    @PostMapping(value = "/user")
    public ResponseEntity<Integer> userRegister(@RequestBody @ApiParam(value="등록하려는 회원의 정보", required = true) MemberDto memberDto) {
    ...
    @ApiOperation(value = "회원정보검색", notes="userid에 해당하는 회원 한 명의 정보를 리턴합니다.")
    @GetMapping(value = "/user/{userid}")
    public ResponseEntity<MemberDto> userInfo(@PathVariable("userid") @ApiParam(value="조회하려는 회원의 userid", required = true)String userid) {
    ...
    @ApiOperation(value = "회원정보수정", notes="userid에 해당하는 회원 한 명의 정보를 수정합니다.")
    @PutMapping(value = "/user/{userid}")
    public ResponseEntity<Integer> userModify(@RequestBody @ApiParam(value="등록하려는 회원의 정보", required = true) MemberDto memberDto) {
    ...
    @ApiOperation(value = "회원정보삭제", notes="userid에 해당하는 회원 한 명의 정보를 삭제합니다.")
    @DeleteMapping(value = "/user/{userid}")
    public ResponseEntity<Integer> userDelete(@PathVariable("userid") @ApiParam(value="삭제하려는 회원의 userid", required = true) String userid) {
